...
export function Footer() {
  ...
  return (
    <footer className="bg-background dark:bg-slate-900 text-foreground dark:text-white border-t border-border">
      <div className="container-custom mx-auto py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="text-center md:text-left">
           ...
           <div className="text-center md:text-left">
            <h4 className="text-xl font-poppins-bold mb-4 text-foreground">Normas da empresa</h4>
            <ul className="space-y-3">
              <li>
                <Link
                  href="/politicas"
                  className="text-foreground/70 hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block flex items-center gap-2"
                >
            ...
            <p className="text-foreground/60 text-xs mt-4 leading-relaxed">
              Acesse documentos importantes, políticas internas e diretrizes da empresa
            </p>
          </div>

          <div className="text-center md:text-left">
            <h4 className="text-xl font-poppins-bold mb-4 text-foreground">Formulários</h4>
          ...
          <div className="text-center md:text-left">
            <h4 className="text-lg font-medium mb-4 text-foreground">Reportar Bug</h4>
