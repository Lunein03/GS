  ...
  return (
    <FormProvider {...form}>
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden">
        ...
        <div className={cn(
          "border-r border-border flex-col overflow-hidden transition-all duration-300 min-h-0",
          isPreviewFullscreen ? "flex-1 flex" : isPreviewVisible ? "w-[450px] hidden lg:flex" : "w-0 hidden"
        )}>
          {/* Preview Header */}
          ...
          <ProposalDocumentEditor 
            ...
            data={{
              ...
              // Fix: Use stable date to prevent PDF refresh loop
        ...
        {/* Right: Tabs */}
        <div className={cn(
          "flex flex-col bg-background overflow-hidden transition-all duration-300 min-h-0",
          ...
          >
            ...
            <div className="px-4 md:px-6 pt-3 border-b border-border bg-card/50">
              <TabsList className="bg-transparent h-auto p-0 gap-1 md:gap-3 overflow-x-auto no-scrollbar justify-start w-full">
                  ...
                  <div key={tab.key} className="flex items-center shrink-0">
                    ...
                    <TabsTrigger 
                      ...
                      className={cn(
                        ...
                        "rounded-none px-2 md:px-0 py-2 pb-3",
