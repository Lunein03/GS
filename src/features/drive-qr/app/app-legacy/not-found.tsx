  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-6 bg-background px-4 py-16">
      <div className="text-center">
        <p className="text-sm font-medium uppercase tracking-wide text-primary">Página não encontrada</p>
        <h1 className="mt-2 text-3xl font-medium text-foreground sm:text-4xl">Ops, esse endereço não existe.</h1>
