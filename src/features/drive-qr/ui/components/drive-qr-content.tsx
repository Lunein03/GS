  ...
  return (
    <div className="space-y-6 font-inter">
      ...
      <header className="space-y-3">
        ...
        <h1 className="font-inter text-center text-3xl font-bold text-foreground sm:text-4xl">Drive QR Scanner</h1>
      ...
      <div className="rounded-2xl border border-border bg-card p-6 sm:p-8">
        <div className="grid gap-8 lg:grid-cols-[1fr_400px] lg:items-start">
          <div className="space-y-4">
            <h2 className="font-inter text-xl font-semibold text-foreground sm:text-2xl">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <div className="rounded-xl border border-border bg-card p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-foreground">{summary.successes}</p>
        ...
        <div className="rounded-xl border border-border bg-card p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-foreground">{summary.errors}</p>
      ...
      {results.length > 0 ? (
        <div className="space-y-5">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h3 className="font-inter text-xl font-semibold text-foreground">Resultados</h3>
        ...
        <div className="rounded-2xl border border-dashed border-border bg-muted/30 p-12">
          <div className="mx-auto max-w-xl space-y-4 text-center">
            ...
            <div className="space-y-2">
              <h3 className="font-inter text-lg font-semibold text-foreground">Nenhum QR code processado ainda</h3>
              <p className="text-sm text-muted-foreground">
