          ...
          <div className="space-y-20">
            ...
            <section className="space-y-10">
              <div className="flex flex-col items-center gap-5">
                ...
                <h2 className="text-xl font-bold text-foreground md:text-2xl">Abrangência</h2>
              </div>
            ...
            <section className="space-y-10">
              <div className="flex flex-col items-center gap-5">
                ...
                <h2 className="text-xl font-bold text-foreground md:text-2xl text-center">Princípios Gerais</h2>
              </div>
              ...
              <div className="mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-card/50 rounded-2xl border border-border/50 p-8 shadow-sm hover:shadow-md transition-shadow text-center space-y-4">
                  <h3 className="text-lg font-semibold text-foreground">Transparência</h3>
                  <p className="text-sm leading-relaxed text-muted-foreground md:text-base">
                    Todos os gastos devem ser devidamente registrados e documentados.
                  </p>
                </div>
                <div className="bg-card/50 rounded-2xl border border-border/50 p-8 shadow-sm hover:shadow-md transition-shadow text-center space-y-4">
                  <h3 className="text-lg font-semibold text-foreground">Responsabilidade</h3>
                  <p className="text-sm leading-relaxed text-muted-foreground md:text-base">
            ...
            <section className="space-y-10">
              <div className="flex flex-col items-center gap-5">
                ...
                <h2 className="text-xl font-bold text-foreground md:text-2xl text-center">Autorização de Despesas</h2>
              </div>
                  ...
                  <div className="space-y-4 text-left text-sm leading-relaxed text-muted-foreground md:text-base lg:leading-loose">
                    ...
                    <div className="space-y-4">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center gap-2 text-sm font-semibold text-secondary underline decoration-2 underline-offset-4 transition-colors hover:text-secondary/80"
                      >
            ...
            <section className="space-y-10">
              <div className="flex flex-col items-center gap-5">
                ...
                <h2 className="text-xl font-bold text-foreground md:text-2xl text-center">Uso do Cartão Corporativo</h2>
              </div>

              <div className="mx-auto max-w-6xl space-y-8">
                <div className="bg-card/50 rounded-2xl border border-border/50 p-8 shadow-sm">
                  <div className="space-y-6 text-left text-sm leading-relaxed text-muted-foreground md:text-base lg:leading-loose">
                    <h3 className="text-lg font-semibold text-foreground">Limites e Restrições</h3>
                ...
                <div className="bg-card/50 rounded-2xl border border-border/50 p-8 shadow-sm">
                  <div className="space-y-6 text-left text-sm leading-relaxed text-muted-foreground md:text-base lg:leading-loose">
                    <h3 className="text-lg font-semibold text-foreground">Utilização de Uber e Serviços Similares</h3>
                    <p>
            ...
            <section className="space-y-10">
              <div className="flex flex-col items-center gap-5">
                ...
                <h2 className="text-xl font-bold text-foreground md:text-2xl">Penalidades</h2>
              </div>
            ...
            <section className="space-y-10">
              <div className="flex flex-col items-center gap-5">
                ...
                <h2 className="text-xl font-bold text-foreground md:text-2xl text-center">Revisão da Política</h2>
              </div>
